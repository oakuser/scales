...
//todo: в методах parseWeight и testPlanogram предсказание что покажут весы произсодится простым округлением.
//Предполагаю это не совсем так, на разных загруженностях весов прилипания к краям дискреты происходят при разных расстояниях до границ дискрет.
